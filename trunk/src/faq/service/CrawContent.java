	...
	public CrawContent()
	{
		...
		try {
			...
			if(listQuestion.size() > 0)
			{
				...
				{
					URL dataURL = new URL("http://72.55.164.55/efreedom.php?url="+listQuestion.get(j).getUrl());
...
//					doc = Jsoup.connect(listQuestion.get(j).getUrl()).get();
					...
					try {
						dataURL = new URL("http://72.55.164.55/efreedom.php?url="+listQuestion.get(j).getUrl().replaceAll("efreedom.com", "de.efreedom.com"));
					...
					try {
						dataURL = new URL("http://72.55.164.55/efreedom.php?url="+listQuestion.get(j).getUrl().replaceAll("efreedom.com", "es.efreedom.com"));
						connection1 = (HttpURLConnection) dataURL.openConnection();
						connection1.setRequestProperty("User-Agent", "Mozilla/5.0 (compatible; Googlebot/2.1; +http://www.google.com/bot.html)");
						connection1.setReadTimeout(500000);
						connection1.setConnectTimeout(1000000);
					...
					try {
						dataURL = new URL("http://72.55.164.55/efreedom.php?url="+listQuestion.get(j).getUrl().replaceAll("efreedom.com", "fr.efreedom.com"));
						connection1 = (HttpURLConnection) dataURL.openConnection();
						connection1.setRequestProperty("User-Agent", "Mozilla/5.0 (compatible; Googlebot/2.1; +http://www.google.com/bot.html)");
						connection1.setReadTimeout(500000);
						connection1.setConnectTimeout(1000000);
					...
					try {
						dataURL = new URL("http://72.55.164.55/efreedom.php?url="+listQuestion.get(j).getUrl().replaceAll("efreedom.com", "hi.efreedom.com"));
						connection1 = (HttpURLConnection) dataURL.openConnection();
						connection1.setRequestProperty("User-Agent", "Mozilla/5.0 (compatible; Googlebot/2.1; +http://www.google.com/bot.html)");
						connection1.setReadTimeout(500000);
						connection1.setConnectTimeout(1000000);
					...
					try {
						dataURL = new URL("http://72.55.164.55/efreedom.php?url="+listQuestion.get(j).getUrl().replaceAll("efreedom.com", "ja.efreedom.com"));
						connection1 = (HttpURLConnection) dataURL.openConnection();
						connection1.setRequestProperty("User-Agent", "Mozilla/5.0 (compatible; Googlebot/2.1; +http://www.google.com/bot.html)");
						connection1.setReadTimeout(500000);
						connection1.setConnectTimeout(1000000);
					...
					try {
						dataURL = new URL("http://72.55.164.55/efreedom.php?url="+listQuestion.get(j).getUrl().replaceAll("efreedom.com", "ko.efreedom.com"));
						connection1 = (HttpURLConnection) dataURL.openConnection();
						connection1.setRequestProperty("User-Agent", "Mozilla/5.0 (compatible; Googlebot/2.1; +http://www.google.com/bot.html)");
						connection1.setReadTimeout(500000);
						connection1.setConnectTimeout(1000000);
					...
					try {
						dataURL = new URL("http://72.55.164.55/efreedom.php?url="+listQuestion.get(j).getUrl().replaceAll("efreedom.com", "nl.efreedom.com"));
						connection1 = (HttpURLConnection) dataURL.openConnection();
						connection1.setRequestProperty("User-Agent", "Mozilla/5.0 (compatible; Googlebot/2.1; +http://www.google.com/bot.html)");
						connection1.setReadTimeout(500000);
						connection1.setConnectTimeout(1000000);
					...
					try {
						dataURL = new URL("http://72.55.164.55/efreedom.php?url="+listQuestion.get(j).getUrl().replaceAll("efreedom.com", "pl.efreedom.com"));
						connection1 = (HttpURLConnection) dataURL.openConnection();
						connection1.setRequestProperty("User-Agent", "Mozilla/5.0 (compatible; Googlebot/2.1; +http://www.google.com/bot.html)");
						connection1.setReadTimeout(500000);
						connection1.setConnectTimeout(1000000);
					...
					try {
						dataURL = new URL("http://72.55.164.55/efreedom.php?url="+listQuestion.get(j).getUrl().replaceAll("efreedom.com", "pt.efreedom.com"));
						connection1 = (HttpURLConnection) dataURL.openConnection();
						connection1.setRequestProperty("User-Agent", "Mozilla/5.0 (compatible; Googlebot/2.1; +http://www.google.com/bot.html)");
						connection1.setReadTimeout(500000);
						connection1.setConnectTimeout(1000000);
					...
					try {
						dataURL = new URL("http://72.55.164.55/efreedom.php?url="+listQuestion.get(j).getUrl().replaceAll("efreedom.com", "ro.efreedom.com"));
						connection1 = (HttpURLConnection) dataURL.openConnection();
						connection1.setRequestProperty("User-Agent", "Mozilla/5.0 (compatible; Googlebot/2.1; +http://www.google.com/bot.html)");
						connection1.setReadTimeout(500000);
						connection1.setConnectTimeout(1000000);
					...
					try {
						dataURL = new URL("http://72.55.164.55/efreedom.php?url="+listQuestion.get(j).getUrl().replaceAll("efreedom.com", "ru.efreedom.com"));
						connection1 = (HttpURLConnection) dataURL.openConnection();
						connection1.setRequestProperty("User-Agent", "Mozilla/5.0 (compatible; Googlebot/2.1; +http://www.google.com/bot.html)");
						connection1.setReadTimeout(500000);
						connection1.setConnectTimeout(1000000);
					...
					try {
						dataURL = new URL("http://72.55.164.55/efreedom.php?url="+listQuestion.get(j).getUrl().replaceAll("efreedom.com", "tr.efreedom.com"));
						connection1 = (HttpURLConnection) dataURL.openConnection();
						connection1.setRequestProperty("User-Agent", "Mozilla/5.0 (compatible; Googlebot/2.1; +http://www.google.com/bot.html)");
						connection1.setReadTimeout(500000);
						connection1.setConnectTimeout(1000000);
					...
					try {
						dataURL = new URL("http://72.55.164.55/efreedom.php?url="+listQuestion.get(j).getUrl().replaceAll("efreedom.com", "zh.efreedom.com"));
						connection1 = (HttpURLConnection) dataURL.openConnection();
						connection1.setRequestProperty("User-Agent", "Mozilla/5.0 (compatible; Googlebot/2.1; +http://www.google.com/bot.html)");
						connection1.setReadTimeout(500000);
						connection1.setConnectTimeout(1000000);
